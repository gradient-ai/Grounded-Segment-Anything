...
Run this repo in a Free GPU powered Gradient Notebook
...
| :-----------------------------------------------------: |
|              _A person with pink clothes_               |

| ![space-1.jpg](assets/osx/grounded_sam_osx_output2.jpg) |
| :-----------------------------------------------------: |
|                _A man with a sunglasses_                |
